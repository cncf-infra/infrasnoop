...
:
* Job urls
we have a list of all the urls in all the index pages of our job artifacts. let's load it into a table!
...
: --------+---------------+-------+----------
:  public | committee     | table | postgres
:  public | sig           | table | postgres
:  public | user_group    | table | postgres
:  public | working_group | table | postgres
: (4 rows)
:
...
:  Schema |   Name   | Type  |  Owner
: --------+----------+-------+----------
:  prow   | artifact | table | postgres
:  prow   | deck     | table | postgres
:  prow   | job_raw  | table | postgres
:  prow   | owners   | table | postgres
: (4 rows)
:
...
: postgres=*# postgres=*# COPY 145646
: postgres=*# postgres=*# COMMIT

#+begin_src sql-mode
ALTER TABLE prow.artifact
RENAME COLUMN artifact_url TO url;
#+end_src
...
#+RESULTS:
: BEGIN
: postgres=*# postgres-*# postgres-*# postgres-*# postgres-*# postgres-*# INSERT 0 145646
: postgres=*# COMMIT

#+begin_src sql-mode
select distinct length(build_id) from prow.artifact;
#+end_src
